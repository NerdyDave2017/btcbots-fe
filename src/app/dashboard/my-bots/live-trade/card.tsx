    ...
    <div className="w-[350px] py-4 px-3 bg-[#eaf0f6] rounded-[32px] flex-col justify-start items-start gap-4 flex">
      ...
      <div className="w-full px-4 py-2 bg-[#c3dbf5] rounded-lg">
        <div className="flex justify-between items-center">
          <p className="text-[#3c3c43]/60 text-sm font-normal font-['Sora']">
            Current Profit
          </p>
          <div className="text-[#3c3c43]/60 text-sm font-normal font-['Sora']">
            Size
          </div>
        </div>
        <div className="flex justify-between items-center">
      ...
      <div className="w-full px-4 flex-col justify-start items-center gap-2.5 inline-flex">
        <p className="text-[#006fe3] text-base font-normal font-['Sora']">
          Open Live Chart
        </p>
        <p className="text-[#006fe3] text-base font-normal font-['Sora']">
          Trade Orders
